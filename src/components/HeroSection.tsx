...
import { ArrowDown, Download, Eye, Shield, Lock, Search, Zap, Github, Linkedin, Mail, ExternalLink } from 'lucide-react';
        ...
        <div className="flex flex-col lg:flex-row items-center justify-between gap-12">
          ...
          <div className="lg:w-1/2 text-center lg:text-left order-1 lg:order-2">
            <div className="mb-6">
              ...
              Cybersecurity professional with hands-on experience in both - <br /> Blue Team <span className="text-primary font-semibold">(SOC operation, threat hunt, vulnerability analysis)</span> and, <br />
              Red Team <span className="text-accent font-semibold">(Red Team operations, penetration testing & Vulnerability exploitation, Ethical hacking)</span> domains. <br />
